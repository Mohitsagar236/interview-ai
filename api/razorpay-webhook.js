...
async function sendDownloadEmail({ email, name, productType, paymentId, amount }) {
    try {
        ...
        const downloadUrls = {
            basic: 'https://yourdomain.com/downloads/Interview AI Assistant Setup 0.1.0.exe',
            plus: 'https://yourdomain.com/downloads/Interview AI Assistant Setup 0.1.0.exe',
            advanced: 'https://yourdomain.com/downloads/Interview AI Assistant Setup 0.1.0.exe',
            windows: 'https://yourdomain.com/downloads/Interview AI Assistant Setup 0.1.0.exe',
