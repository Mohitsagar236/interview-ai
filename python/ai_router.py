...
class ModelRouter:
    ...
    def __init__(
        ...
        Args:
            default_model: Fallback model if routing disabled
            enable_routing: If False, always use default_model
            budget_mode: If True, prefer cheaper models
            max_cost_per_request: Maximum allowed cost per API call
        """
