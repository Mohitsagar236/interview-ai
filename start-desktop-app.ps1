...
if ($pythonProcess) {
    ...
    Write-Host "⚠️  Backend not running. Starting it now..." -ForegroundColor Yellow
    ...
    if ($pythonProcess) {
        ...
        Write-Host "⚠️  Could not verify backend startup, but continuing..." -ForegroundColor Yellow
    }
}
