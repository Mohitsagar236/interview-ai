...
class StreamingTranscriptionEngine:
    ...
    def __init__(self, api_key: Optional[str] = None, model: Optional[str] = None):
        ...
        self._override_api_key = api_key  # BYOK: caller-supplied key takes precedence
    ...
    async def set_language(self, language: str) -> bool:
        """Change the transcription language (requires reconnection)"""
        self.logger.info(f"[Engine] Changing language to: {language}")
